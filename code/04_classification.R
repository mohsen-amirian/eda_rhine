...
colset_4 <-  c("#D35C37", "#BF9A77", "#D6C6B9", "#97B8C2") ###colors in the plots
theme_set(theme_bw())
runoff_summary
...
runoff_stats
for_cor
for_cor_mat <- for_cor[, c('mean_day', 'area')] ####this is handy when we're dealing with more than 2 variables
cor(for_cor_mat)
